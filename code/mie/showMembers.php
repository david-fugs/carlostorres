...
<div class="flex">
    <div class="box">
        <form action="showMembers.php" method="get" class="form">
            <input name="cc_mie" type="text" placeholder="Cedula Miembro">
            <input name="nom_ape_mie" type="text" placeholder="Nombre Miembro">
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo '
        ...
        <td data-label="NOMBRE">' . $row['nom_ape_mie'] . '</td>
